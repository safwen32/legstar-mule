...
/**
 * Transformer provider for Record1 java data object.
 *
 */
public class Record1Transformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public Record1Transformers() {
        super(new Record1JavaToHostTransformer(),
                new Record1HostToJavaTransformer());
    }
     ...
     */
    public Record1 toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public Record1 toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public Record1 toJava(final byte[] hostData, final int offset,
